...
public class Sprite {
    ...
    public static final Sprite playerDown =
            new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.tiles, 12, 15);
    public static final Sprite playerLeft =
    ...
    public static final Sprite minvoDead =
    ...
    // Phoenix monster.
    public static Sprite phoenixDown1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixDown2 = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixDown3 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixDown4 = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.phoenix, 16, 16);

    public static Sprite phoenixUp1 = new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixUp2 = new Sprite(DEFAULT_SIZE, 1, 3, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixUp3 = new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixUp4 = new Sprite(DEFAULT_SIZE, 3, 3, SpriteSheet.phoenix, 16, 16);

    public static Sprite phoenixRight1 =
            new Sprite(DEFAULT_SIZE, 0, 2, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixRight2 =
            new Sprite(DEFAULT_SIZE, 1, 2, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixRight3 =
            new Sprite(DEFAULT_SIZE, 2, 2, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixRight4 =
            new Sprite(DEFAULT_SIZE, 3, 2, SpriteSheet.phoenix, 16, 16);

    public static Sprite phoenixLeft1 = new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixLeft2 = new Sprite(DEFAULT_SIZE, 1, 1, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixLeft3 = new Sprite(DEFAULT_SIZE, 2, 1, SpriteSheet.phoenix, 16, 16);
    public static Sprite phoenixLeft4 = new Sprite(DEFAULT_SIZE, 3, 1, SpriteSheet.phoenix, 16, 16);

    // dragon monster.
    public static Sprite dragonDown1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonDown2 = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonDown3 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonDown4 = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.dragon, 16, 16);

    public static Sprite dragonUp1 = new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonUp2 = new Sprite(DEFAULT_SIZE, 1, 3, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonUp3 = new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonUp4 = new Sprite(DEFAULT_SIZE, 3, 3, SpriteSheet.dragon, 16, 16);

    public static Sprite dragonRight1 = new Sprite(DEFAULT_SIZE, 0, 2, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonRight2 = new Sprite(DEFAULT_SIZE, 1, 2, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonRight3 = new Sprite(DEFAULT_SIZE, 2, 2, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonRight4 = new Sprite(DEFAULT_SIZE, 3, 2, SpriteSheet.dragon, 16, 16);

    public static Sprite dragonLeft1 = new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonLeft2 = new Sprite(DEFAULT_SIZE, 1, 1, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonLeft3 = new Sprite(DEFAULT_SIZE, 2, 1, SpriteSheet.dragon, 16, 16);
    public static Sprite dragonLeft4 = new Sprite(DEFAULT_SIZE, 3, 1, SpriteSheet.dragon, 16, 16);

    public static Sprite fire1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.fireMonster, 16, 16);
    public static Sprite fire2 = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.fireMonster, 16, 16);
    public static Sprite fire3 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.fireMonster, 16, 16);

    // bat monster.
    public static Sprite batDown1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.batMonster, 16, 16);
    public static Sprite batDown2 = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.batMonster, 16, 16);
    public static Sprite batDown3 = new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.batMonster, 16, 16);
    public static Sprite batDown4 = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.batMonster, 16, 16);

    public static Sprite batUp1 = new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.batMonster, 16, 16);
    public static Sprite batUp2 = new Sprite(DEFAULT_SIZE, 1, 3, SpriteSheet.batMonster, 16, 16);
    public static Sprite batUp3 = new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.batMonster, 16, 16);
    public static Sprite batUp4 = new Sprite(DEFAULT_SIZE, 3, 3, SpriteSheet.batMonster, 16, 16);

    public static Sprite batRight1 = new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.batMonster, 16, 16);
    public static Sprite batRight2 = new Sprite(DEFAULT_SIZE, 1, 1, SpriteSheet.batMonster, 16, 16);
    public static Sprite batRight3 = new Sprite(DEFAULT_SIZE, 2, 1, SpriteSheet.batMonster, 16, 16);
    public static Sprite batRight4 = new Sprite(DEFAULT_SIZE, 3, 1, SpriteSheet.batMonster, 16, 16);

    public static Sprite batLeft1 = new Sprite(DEFAULT_SIZE, 0, 2, SpriteSheet.batMonster, 16, 16);
    public static Sprite batLeft2 = new Sprite(DEFAULT_SIZE, 1, 2, SpriteSheet.batMonster, 16, 16);
    public static Sprite batLeft3 = new Sprite(DEFAULT_SIZE, 2, 2, SpriteSheet.batMonster, 16, 16);
    public static Sprite batLeft4 = new Sprite(DEFAULT_SIZE, 3, 2, SpriteSheet.batMonster, 16, 16);


    // ALL
    public static final Sprite mobDead11 =
            new Sprite(DEFAULT_SIZE, 15, 0, SpriteSheet.tiles, 16, 16);
    public static final Sprite mobDead12 =
            new Sprite(DEFAULT_SIZE, 15, 1, SpriteSheet.tiles, 16, 16);
    public static final Sprite mobDead13 =
    ...
    public static final Sprite explosionVerticalTopLast =
            new Sprite(DEFAULT_SIZE, 1, 4, SpriteSheet.tiles, 16, 16);
    public static final Sprite explosionVerticalTopLast1 =
            new Sprite(DEFAULT_SIZE, 2, 4, SpriteSheet.tiles, 16, 16);
    public static final Sprite explosionVerticalTopLast2 =
            new Sprite(DEFAULT_SIZE, 3, 4, SpriteSheet.tiles, 16, 16);

    public static final Sprite explosionVerticalDownLast =
            new Sprite(DEFAULT_SIZE, 1, 6, SpriteSheet.tiles, 16, 16);
    public static final Sprite explosionVerticalDownLast1 =
            new Sprite(DEFAULT_SIZE, 2, 6, SpriteSheet.tiles, 16, 16);
    public static final Sprite explosionVerticalDownLast2 =
     ...
     */
    public static final Sprite grass1 =
            new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.newtiles, 32, 32);
    public static final Sprite wall1 = new Sprite(DEFAULT_SIZE, 1, 0, SpriteSheet.newtiles, 32, 32);
    public static final Sprite brick1 =
            new Sprite(DEFAULT_SIZE, 2, 0, SpriteSheet.newtiles, 32, 32);

    public static final Sprite grass2 =
            new Sprite(DEFAULT_SIZE, 0, 1, SpriteSheet.newtiles, 32, 32);
    public static final Sprite wall2 = new Sprite(DEFAULT_SIZE, 1, 1, SpriteSheet.newtiles, 32, 32);
    public static final Sprite brick2 =
            new Sprite(DEFAULT_SIZE, 2, 1, SpriteSheet.newtiles, 32, 32);

    public static final Sprite grass3 =
            new Sprite(DEFAULT_SIZE, 0, 2, SpriteSheet.newtiles, 32, 32);
    public static final Sprite wall3 = new Sprite(DEFAULT_SIZE, 1, 2, SpriteSheet.newtiles, 32, 32);
    public static final Sprite brick3 =
            new Sprite(DEFAULT_SIZE, 2, 2, SpriteSheet.newtiles, 32, 32);

    public static final Sprite grass4 =
            new Sprite(DEFAULT_SIZE, 0, 3, SpriteSheet.newtiles, 32, 32);
    public static final Sprite wall4 = new Sprite(DEFAULT_SIZE, 1, 3, SpriteSheet.newtiles, 32, 32);
    public static final Sprite brick4 =
            new Sprite(DEFAULT_SIZE, 2, 3, SpriteSheet.newtiles, 32, 32);

    public static final Sprite grass5 =
            new Sprite(DEFAULT_SIZE, 0, 4, SpriteSheet.newtiles, 32, 32);
    public static final Sprite wall5 = new Sprite(DEFAULT_SIZE, 1, 4, SpriteSheet.newtiles, 32, 32);
    public static final Sprite brick5 =
            new Sprite(DEFAULT_SIZE, 2, 4, SpriteSheet.newtiles, 32, 32);

    public static final Sprite grass6 =
            new Sprite(DEFAULT_SIZE, 0, 5, SpriteSheet.newtiles, 32, 32);
    public static final Sprite wall6 = new Sprite(DEFAULT_SIZE, 1, 5, SpriteSheet.newtiles, 32, 32);
    public static final Sprite brick6 =
            new Sprite(DEFAULT_SIZE, 2, 5, SpriteSheet.newtiles, 32, 32);

    public static final Sprite grass7 =
            new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.newtiles, 32, 32);
    public static final Sprite wall7 = new Sprite(DEFAULT_SIZE, 4, 0, SpriteSheet.newtiles, 32, 32);
    public static final Sprite brick7 =
            new Sprite(DEFAULT_SIZE, 5, 0, SpriteSheet.newtiles, 32, 32);
