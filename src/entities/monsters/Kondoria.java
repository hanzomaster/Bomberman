    ...
    public void update() {
        ...
        if (direction == 0)
            this.setImg(Sprite.movingSprite(Sprite.kondoriaLeft1, Sprite.kondoriaLeft2,
                    Sprite.kondoriaLeft3, animate, timeTransfer).getFxImage());
        else if (direction == 1)
            this.setImg(Sprite.movingSprite(Sprite.kondoriaRight1, Sprite.kondoriaRight2,
                    Sprite.kondoriaRight3, animate, timeTransfer).getFxImage());
        else if (direction == 2)
            ...
            this.setImg(Sprite.movingSprite(Sprite.kondoriaRight1, Sprite.kondoriaLeft2,
                    Sprite.kondoriaRight2, animate, timeTransfer).getFxImage());
